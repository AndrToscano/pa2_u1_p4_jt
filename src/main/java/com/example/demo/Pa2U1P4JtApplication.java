...
public class Pa2U1P4JtApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		 ...
		 * y desarrollo de aplicacione empresariales
		 * basadas en Spring
		 */
		...
		MatriculaCalculo matriculaCalculo = new MatriculaCalculo();
		matriculaCalculo.realizarCalculo("1");
	}
